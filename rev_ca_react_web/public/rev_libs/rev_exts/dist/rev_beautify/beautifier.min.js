        ...
        var t = {
                    ...
                    (s.prototype = new n()),
                        ...
                        (s.prototype._read_template = function () {
                            ...
                            if ("<" === e) {
                                ...
                                "{" === e &&
                                    (this._disabled.handlebars || this._excluded.handlebars || (t = (t = (t = t || this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars_unescaped.read()) || this.__patterns.handlebars.read()),
                                    this._disabled.django || (this._excluded.django || this._excluded.handlebars || (t = t || this.__patterns.django_value.read()), this._excluded.django || (t = (t = t || this.__patterns.django_comment.read()) || this.__patterns.django.read())),
                ...
                434: function (t, e, i) {
                    var n = i(492).E,
                        ...
                        l = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
                    function c(t, e) {
                        (this._source_text = t || ""), (this._options = new n(e)), (this._ch = null), (this._input = null), (this.NESTED_AT_RULE = { "@page": !0, "@font-face": !0, "@keyframes": !0, "@media": !0, "@supports": !0, "@document": !0 }), (this.CONDITIONAL_GROUP_RULE = { "@media": !0, "@supports": !0, "@document": !0 });
                    }
                    (c.prototype.eatString = function (t) {
                        ...
                        (c.prototype.beautify = function () {
                            ...
                            for (var n, c, f = 0, d = !1, g = !1, b = !1, m = !1, k = !1, y = this._ch; (n = "" !== this._input.read(h)), (c = y), (this._ch = this._input.next()), "\\" === this._ch && this._input.hasNext() && (this._ch += this._input.next()), (y = this._ch), this._ch; )
                                if ("/" === this._ch && "*" === this._input.peek()) {
                                    ...
                                    if ((this.preserveSingleSpace(n), "{" === this._input.peek())) this.print_string(this._ch + this.eatString("}"));
                                        ...
                                        v.match(/[ :]$/) && ((v = this.eatString(": ").replace(/\s$/, "")), this.print_string(v), (this._output.space_before_token = !0)), "extend" === (v = v.replace(/\s$/, "")) ? (m = !0) : "import" === v && (k = !0), v in this.NESTED_AT_RULE ? ((this._nestedLevel += 1), v in this.CONDITIONAL_GROUP_RULE && (b = !0)) : d || 0 !== f || -1 === v.indexOf(":") || ((g = !0), this.indent());
                                    }
                                else
                                    "#" === this._ch && "{" === this._input.peek()
                                        ...
                                        ? (g && ((g = !1), this.outdent()),
                                          ...
                                          "expand" === this._options.brace_style ? (this._output.add_new_line(), this.print_string(this._ch), this.indent(), this._output.set_indent(this._indentLevel)) : (this.indent(), this.print_string(this._ch)),
                                          this.eatWhitespace(!0),
                                          this._output.add_new_line())
                                        : "}" === this._ch
                                        ? (this.outdent(), this._output.add_new_line(), "{" === c && this._output.trim(!0), (k = !1), (m = !1), g && (this.outdent(), (g = !1)), this.print_string(this._ch), (d = !1), this._nestedLevel && this._nestedLevel--, this.eatWhitespace(!0), this._output.add_new_line(), this._options.newline_between_rules && !this._output.just_added_blankline() && "}" !== this._input.peek() && this._output.add_new_line(!0))
                                        : ":" === this._ch
                                        ...
                                        : ";" === this._ch
                                        ? 0 === f
                                            ? (g && (this.outdent(), (g = !1)), (m = !1), (k = !1), this.print_string(this._ch), this.eatWhitespace(!0), "/" !== this._input.peek() && this._output.add_new_line())
                                            : (this.print_string(this._ch), this.eatWhitespace(!0), (this._output.space_before_token = !0))
                                        : "(" === this._ch
                                        ? this._input.lookBack("url")
                                            ? (this.print_string(this._ch), this.eatWhitespace(), f++, this.indent(), (this._ch = this._input.next()), ")" === this._ch || '"' === this._ch || "'" === this._ch ? this._input.back() : this._ch && (this.print_string(this._ch + this.eatString(")")), f && (f--, this.outdent())))
                                            : (this.preserveSingleSpace(n), this.print_string(this._ch), this.eatWhitespace(), f++, this.indent())
                                        : ")" === this._ch
                                        ? (f && (f--, this.outdent()), this.print_string(this._ch))
                                        : "," === this._ch
                                        ? (this.print_string(this._ch), this.eatWhitespace(!0), !this._options.selector_separator_newline || g || 0 !== f || k || m ? (this._output.space_before_token = !0) : this._output.add_new_line())
                ...
                843: function (t, e, i) {
                    ...
                    (l.prototype.get_parser_token = function () {
                        ...
                        (c.prototype._handle_tag_close = function (t, e, i) {
                            ...
                            return (
                                ...
                                i.is_unformatted ? t.add_raw_token(e) : ("<" === i.tag_start_char && (t.set_space_before_token("/" === e.text[0], !0), this._is_wrap_attributes_force_expand_multiline && i.has_wrapped_attrs && t.print_newline(!1)), t.print_token(e)),
                        ...
                        (c.prototype._handle_tag_open = function (t, e, i, n) {
                            ...
                            return (
                                (!i.is_unformatted && !i.is_content_unformatted) || i.is_empty_element || e.type !== a.TAG_OPEN || 0 !== e.text.indexOf("</") ? (t.traverse_whitespace(e), this._set_tag_position(t, e, _, i, n), _.is_inline_element || t.set_wrap_point(), t.print_token(e)) : (t.add_raw_token(e), (_.start_tag_token = this._tag_stack.try_pop(_.tag_name))),
                        ...
                        (this.parent = t || null),
                            ...
                            e
                                ? ((this.tag_start_char = e.text[0]),
                                  (this.text = e.text),
                                  "<" === this.tag_start_char ? ((i = e.text.match(/^<([^\s>]*)/)), (this.tag_check = i ? i[1] : "")) : ((i = e.text.match(/^{{(?:[\^]|#\*?)?([^\s}]+)/)), (this.tag_check = i ? i[1] : ""), "{{#>" === e.text && ">" === this.tag_check && null !== e.next && (this.tag_check = e.next.text)),
                    ...
                    (c.prototype._get_tag_open_token = function (t) {
                        ...
                        return (
                            ...
                            (e.is_inline_element = h(e.tag_name, this._options.inline) || "{" === e.tag_start_char),
                            e
                        );
                    }),
                        (c.prototype._set_tag_position = function (t, e, i, n, _) {
                            if (
                                                  ...
                                                  return e.closed
                                                      ? ("script" === t ? (i = "text/javascript") : "style" === t && (i = "text/css"),
                                                        (i =
                                                            ...
                                                            ? (n = "css")
                                                            : i.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1
                                                            ? (n = "javascript")
                                ...
                                h(i.tag_check, this._options.extra_liners) && (t.print_newline(!1), t._output.just_added_blankline() || t.print_newline(!0)),
                                i.is_empty_element)
                            )
                                "{" === i.tag_start_char && "else" === i.tag_check && (this._tag_stack.indent_to_tag(["if", "unless", "each"]), (i.indent_content = !0), t.current_line_has_match(/{{#if/) || t.print_newline(!1)), ("!--" === i.tag_name && _.type === a.TAG_CLOSE && n.is_end_tag && -1 === i.text.indexOf("\n")) || (i.is_inline_element || i.is_unformatted || t.print_newline(!1), this._calcluate_parent_multiline(t, i));
                ...
                41: function (t, e, i) {
                    var n = i(147).d,
                        ...
                        a = i(800).A,
                        u = i(348).c,
                        r = { TAG_OPEN: "TK_TAG_OPEN", TAG_CLOSE: "TK_TAG_CLOSE", ATTRIBUTE: "TK_ATTRIBUTE", EQUALS: "TK_EQUALS", VALUE: "TK_VALUE", COMMENT: "TK_COMMENT", TEXT: "TK_TEXT", UNKNOWN: "TK_UNKNOWN", START: _.START, RAW: _.RAW, EOF: _.EOF },
                        o = new s(/<\!--/, /-->/),
                        h = function (t, e) {
                ...
                282: function (t, e, i) {
                    ...
                    (R.prototype.create_flags = function (t, e) {
                        ...
                        (R.prototype.handle_whitespace_and_comments = function (t, e) {
                            var i = t.newlines,
                                n = this._options.keep_array_indentation && T(this._flags.mode);
                    ...
                    (R.prototype.allow_wrap_or_preserved_newline = function (t, e) {
                        ...
                        (R.prototype.print_newline = function (t, e) {
                            if (!e && ";" !== this._flags.last_token.text && "," !== this._flags.last_token.text && "=" !== this._flags.last_token.text && (this._flags.last_token.type !== h.OPERATOR || "--" === this._flags.last_token.text || "++" === this._flags.last_token.text)) for (var i = this._tokens.peek(); !(this._flags.mode !== m || (this._flags.if_block && l(i, "else")) || this._flags.do_block); ) this.restore_mode();
                        ...
                        (R.prototype.start_of_statement = function (t) {
                            ...
                            return (
                                !!(e =
                                    (e =
                                        (e =
                                            (e = (e = (e = (e = e || (c(this._flags.last_token, ["var", "let", "const"]) && t.type === h.WORD)) || l(this._flags.last_token, "do")) || (!(this._flags.parent.mode === k && this._flags.mode === m) && c(this._flags.last_token, A) && !t.newlines)) || (l(this._flags.last_token, "else") && !(l(t, "if") && !t.comments_before))) ||
                                            (this._flags.last_token.type === h.END_EXPR && (this._previous_flags.mode === w || this._previous_flags.mode === x))) ||
                                        (this._flags.last_token.type === h.WORD && this._flags.mode === b && !this._flags.in_case && !("--" === t.text || "++" === t.text) && "function" !== this._last_last_text && t.type !== h.WORD && t.type !== h.RESERVED)) ||
                                    (this._flags.mode === k && ((":" === this._flags.last_token.text && 0 === this._flags.ternary_depth) || c(this._flags.last_token, ["get", "set"])))) && (this.set_mode(m), this.indent(), this.handle_whitespace_and_comments(t, !0), this.start_of_object_property() || this.allow_wrap_or_preserved_newline(t, c(t, ["do", "for", "if", "while"])), !0)
                            );
                        }),
                        (R.prototype.handle_start_expr = function (t) {
                            ...
                            if ("[" === t.text) {
                                ...
                                (e = y), T(this._flags.mode) && (("[" !== this._flags.last_token.text && ("," !== this._flags.last_token.text || ("]" !== this._last_last_text && "}" !== this._last_last_text))) || this._options.keep_array_indentation || this.print_newline()), p(this._flags.last_token.type, [h.START_EXPR, h.END_EXPR, h.WORD, h.OPERATOR, h.DOT]) || (this._output.space_before_token = !0);
                            } else {
                                if (this._flags.last_token.type === h.RESERVED)
                                    "for" === this._flags.last_token.text
                                        ? ((this._output.space_before_token = this._options.space_before_conditional), (e = w))
                                        ...
                                        : (p(this._flags.last_token.text, r) || "catch" === this._flags.last_token.text) && (this._output.space_before_token = !0);
                        ...
                        (R.prototype.handle_end_expr = function (t) {
                            ...
                            this.handle_whitespace_and_comments(t),
                                ...
                                this._options.space_in_paren && (this._flags.last_token.type !== h.START_EXPR || this._options.space_in_empty_paren ? (this._output.space_before_token = !0) : (this._output.trim(), (this._output.space_before_token = !1))),
                                this.deindent(),
                                this.print_token(t),
                                this.restore_mode(),
                        ...
                        (R.prototype.handle_start_block = function (t) {
                            ...
                            "switch" === this._flags.last_word && this._flags.last_token.type === h.END_EXPR
                                ...
                                ? this.set_mode(b)
                                : i && ((p(i.text, [":", ","]) && p(e.type, [h.STRING, h.WORD, h.RESERVED])) || (p(e.text, ["get", "set", "..."]) && p(i.type, [h.WORD, h.RESERVED])))
                                ? p(this._last_last_text, ["class", "interface"])
                                    ? this.set_mode(b)
                                    : this.set_mode(k)
                                : this._flags.last_token.type === h.OPERATOR && "=>" === this._flags.last_token.text
                                ? this.set_mode(b)
                                : p(this._flags.last_token.type, [h.EQUALS, h.START_EXPR, h.COMMA, h.OPERATOR]) || c(this._flags.last_token, ["return", "throw", "import", "default"])
                                ? this.set_mode(k)
                                : this.set_mode(b);
                            ...
                            ("expand" === this._options.brace_style || ("none" === this._options.brace_style && t.newlines)) && !this._flags.inline_frame
                                ? this._flags.last_token.type !== h.OPERATOR && (_ || this._flags.last_token.type === h.EQUALS || (c(this._flags.last_token, f) && "else" !== this._flags.last_token.text))
                                    ? (this._output.space_before_token = !0)
                        ...
                        (R.prototype.handle_word = function (t) {
                            if (
                                (t.type === h.RESERVED && ((p(t.text, ["set", "get"]) && this._flags.mode !== k) || ("import" === t.text && "(" === this._tokens.peek().text) || (p(t.text, ["as", "from"]) && !this._flags.import_block) || (this._flags.mode === k && ":" === this._tokens.peek().text)) && (t.type = h.WORD),
                                this.start_of_statement(t)
                                    ? c(this._flags.last_token, ["var", "let", "const"]) && t.type === h.WORD && (this._flags.declaration_statement = !0)
                                    : !t.newlines || O(this._flags.mode) || (this._flags.last_token.type === h.OPERATOR && "--" !== this._flags.last_token.text && "++" !== this._flags.last_token.text) || this._flags.last_token.type === h.EQUALS || (!this._options.preserve_newlines && c(this._flags.last_token, ["var", "let", "const", "set", "get"]))
                                    ? this.handle_whitespace_and_comments(t)
                            ...
                            if (this._flags.in_case_statement && c(t, ["case", "default"])) return this.print_newline(), this._flags.last_token.type !== h.END_BLOCK && (this._flags.case_body || this._options.jslint_happy) && this.deindent(), (this._flags.case_body = !1), this.print_token(t), void (this._flags.in_case = !0);
                            if (((this._flags.last_token.type !== h.COMMA && this._flags.last_token.type !== h.START_EXPR && this._flags.last_token.type !== h.EQUALS && this._flags.last_token.type !== h.OPERATOR) || this.start_of_object_property() || this.allow_wrap_or_preserved_newline(t), l(t, "function")))
                                return (
                                    (p(this._flags.last_token.text, ["}", ";"]) || (this._output.just_added_newline() && !p(this._flags.last_token.text, ["(", "[", "{", ":", "=", ","]) && this._flags.last_token.type !== h.OPERATOR)) && (this._output.just_added_blankline() || t.comments_before || (this.print_newline(), this.print_newline(!0))),
                                    this._flags.last_token.type === h.RESERVED || this._flags.last_token.type === h.WORD
                                        ? c(this._flags.last_token, ["get", "set", "new", "export"]) || c(this._flags.last_token, A) || (l(this._flags.last_token, "default") && "export" === this._last_last_text) || "declare" === this._flags.last_token.text
                                            ? (this._output.space_before_token = !0)
                                            : this.print_newline()
                                        : this._flags.last_token.type === h.OPERATOR || "=" === this._flags.last_token.text
                                        ? (this._output.space_before_token = !0)
                                        : (this._flags.multiline_frame || (!O(this._flags.mode) && !T(this._flags.mode))) && this.print_newline(),
                                    this.print_token(t),
                            ...
                            this._flags.last_token.type === h.END_BLOCK
                                ...
                                ? (e = "NEWLINE")
                                : this._flags.last_token.type === h.SEMICOLON && O(this._flags.mode)
                                ? (e = "SPACE")
                                : this._flags.last_token.type === h.STRING
                                ? (e = "NEWLINE")
                                : this._flags.last_token.type === h.RESERVED || this._flags.last_token.type === h.WORD || ("*" === this._flags.last_token.text && (p(this._last_last_text, ["function", "yield"]) || (this._flags.mode === k && p(this._last_last_text, ["{", ","]))))
                                ? (e = "SPACE")
                                ...
                                c(t, ["else", "catch", "finally"])
                                    ? (this._flags.last_token.type !== h.END_BLOCK || this._previous_flags.mode !== b || "expand" === this._options.brace_style || "end-expand" === this._options.brace_style || ("none" === this._options.brace_style && t.newlines)) && !this._flags.inline_frame
                                        ? this.print_newline()
                                    ...
                                    ? c(this._flags.last_token, f) || ("declare" === this._flags.last_token.text && c(t, ["var", "let", "const"]))
                                        ...
                                        ? (this._flags.last_token.type === h.START_EXPR && c(t, ["var", "let", "const"])) || ":" === this._flags.last_token.text || (l(t, "if") && l(t.previous, "else") ? (this._output.space_before_token = !0) : this.print_newline())
                                        : c(t, r) && ")" !== this._flags.last_token.text && this.print_newline()
                                    : this._flags.multiline_frame && T(this._flags.mode) && "," === this._flags.last_token.text && "}" === this._last_last_text
                                    ? this.print_newline()
                        ...
                        (R.prototype.handle_string = function (t) {
                            (!t.text.startsWith("`") || 0 !== t.newlines || "" !== t.whitespace_before || (")" !== t.previous.text && this._flags.last_token.type !== h.WORD)) &&
                                (this.start_of_statement(t)
                                    ? (this._output.space_before_token = !0)
                                    : (this.handle_whitespace_and_comments(t),
                                      this._flags.last_token.type === h.RESERVED || this._flags.last_token.type === h.WORD || this._flags.inline_frame
                                          ? (this._output.space_before_token = !0)
                                          : this._flags.last_token.type === h.COMMA || this._flags.last_token.type === h.START_EXPR || this._flags.last_token.type === h.EQUALS || this._flags.last_token.type === h.OPERATOR
                                          ? this.start_of_object_property() || this.allow_wrap_or_preserved_newline(t)
                                          : !t.text.startsWith("`") || this._flags.last_token.type !== h.END_EXPR || ("]" !== t.previous.text && ")" !== t.previous.text) || 0 !== t.newlines
                                          ? this.print_newline()
                                          : (this._output.space_before_token = !0))),
                                this.print_token(t);
                        }),
                        ...
                        (R.prototype.handle_operator = function (t) {
                            ...
                            if ("*" !== t.text || this._flags.last_token.type !== h.DOT)
                                if ("::" !== t.text) {
                                    if ((this._flags.last_token.type === h.OPERATOR && p(this._options.operator_position, g) && this.allow_wrap_or_preserved_newline(t), ":" === t.text && this._flags.in_case)) return this.print_token(t), (this._flags.in_case = !1), (this._flags.case_body = !0), void (this._tokens.peek().type !== h.START_BLOCK ? (this.indent(), this.print_newline()) : (this._output.space_before_token = !0));
                                    var _ = !0,
                                        s = !0,
                                        a = !1;
                                    ...
                                    if (e) {
                                        ...
                                        "..." === t.text
                                            ...
                                            : (p(t.text, ["--", "++", "!", "~"]) || i) &&
                                              ((this._flags.last_token.type !== h.COMMA && this._flags.last_token.type !== h.START_EXPR) || this.allow_wrap_or_preserved_newline(t),
                                              (_ = !1),
                                              (s = !1),
                                              !t.newlines || ("--" !== t.text && "++" !== t.text) || this.print_newline(!1, !0),
                                              ";" === this._flags.last_token.text && O(this._flags.mode) && (_ = !0),
                                              this._flags.last_token.type === h.RESERVED ? (_ = !0) : this._flags.last_token.type === h.END_EXPR ? (_ = !("]" === this._flags.last_token.text && ("--" === t.text || "++" === t.text))) : this._flags.last_token.type === h.OPERATOR && ((_ = p(t.text, ["--", "-", "++", "+"]) && p(this._flags.last_token.text, ["--", "-", "++", "+"])), p(t.text, ["+", "-"]) && p(this._flags.last_token.text, ["--", "++"]) && (s = !0)),
                        ...
                        (R.prototype.print_block_commment = function (t, e) {
                            ...
                            if ((this.print_newline(!1, e), this.print_token_line_indentation(t), this._output.add_token(n[0]), this.print_newline(!1, e), n.length > 1)) {
                                for (
                                    ...
                                    _ ? (this.print_token_line_indentation(t), this._output.add_token(n[i].replace(/^\s+/g, ""))) : a && n[i] ? (this.print_token_line_indentation(t), this._output.add_token(n[i].substring(r))) : (this._output.current_line.set_indent(-1), this._output.add_token(n[i])), this.print_newline(!1, e);
                        ...
                        (v.prototype._read_string_recursive = function (t, e, i) {
                            ...
                            for (var s = _.read(), a = ""; this._input.hasNext(); ) {
                                ...
                                "\\" === a && this._input.hasNext()
                                    ? ("x" === (n = this._input.peek()) || "u" === n ? (this.has_char_escapes = !0) : "\r" === n && "\n" === this._input.peek(1) && this._input.next(), (a += this._input.next()))
                                    : i && ("${" === i && "$" === a && "{" === this._input.peek() && (a += this._input.next()), i === a && ((a += "`" === t ? this._read_string_recursive("}", e, "`") : this._read_string_recursive("`", e, "${")), this._input.hasNext() && (a += this._input.next()))),
                                    (s += a += _.read());
                            }
                            return s;
                        }),
