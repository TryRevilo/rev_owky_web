        ...
        var i = [
                ...
                function (t) {
                    ...
                    (_.prototype.clone_empty = function () {
                        ...
                        (n.prototype.get_indent_size = function (t, e) {
                            ...
                            return t < 0 && (n = 0), (n += t * this.__indent_size), (n += e = e || 0);
                        }),
                ...
                function (t) {
                    ...
                    (e.prototype.restart = function () {
                        ...
                        (e.prototype.readUntil = function (t, e) {
                            ...
                            return t ? ((i = t.index), e && (i += t[0].length)) : (i = this.__input_length), (n = this.__input.substring(this.__position, i)), (this.__position = i), n;
                        }),
                ...
                function (t, e, n) {
                    ...
                    (n.prototype.tokenize = function () {
                        ...
                        for (var e = new s(a.START, ""), n = null, i = [], _ = new r(); e.type !== a.EOF; ) {
                            for (t = this._get_next_token(e, n); this._is_comment(t); ) _.add(t), (t = this._get_next_token(e, n));
                            _.isEmpty() || ((t.comments_before = _), (_ = new r())), (t.parent = n), this._is_opening(t) ? (i.push(n), (n = t)) : n && this._is_closing(t, n) && (((t.opened = n).closed = t), (n = i.pop()), (t.parent = n)), ((t.previous = e).next = t), this.__tokens.add(t), (e = t);
                        }
                ...
                function (t, e, n) {
                    var i = n(12).Pattern;
                    function _(t, e) {
                        i.call(this, t, e), e ? (this._line_regexp = this._input.get_regexp(e._line_regexp)) : this.__set_whitespace_patterns("", ""), (this.newline_count = 0), (this.whitespace_before_token = "");
                    }
                ...
                function (t, e, n) {
                    ...
                    function s(t, e) {
                        i.call(this, t, e), (this.__template_pattern = null), (this._disabled = Object.assign({}, _)), (this._excluded = Object.assign({}, _)), e && ((this.__template_pattern = this._input.get_regexp(e.__template_pattern)), (this._excluded = Object.assign(this._excluded, e._excluded)), (this._disabled = Object.assign(this._disabled, e._disabled)));
                        t = new i(t);
                        this.__patterns = {
                ...
                function (t, e, n) {
                    ...
                    (d.prototype.get_parser_token = function () {
                        ...
                        (g.prototype.beautify = function () {
                            ...
                            for (var a = null, o = r.next(); o.type !== u.EOF; )
                                o.type === u.TAG_OPEN || o.type === u.COMMENT ? (_ = a = this._handle_tag_open(s, o, _, i)) : o.type === u.ATTRIBUTE || o.type === u.EQUALS || o.type === u.VALUE || (o.type === u.TEXT && !_.tag_complete) ? (a = this._handle_inside_tag(s, o, _, r)) : o.type === u.TAG_CLOSE ? (a = this._handle_tag_close(s, o, _)) : o.type === u.TEXT ? (a = this._handle_text(s, o, _)) : s.add_raw_token(o), (i = a), (o = r.next());
                        ...
                        (g.prototype._handle_tag_close = function (t, e, n) {
                            ...
                            return (
                                ...
                                n.is_unformatted ? t.add_raw_token(e) : ("<" === n.tag_start_char && (t.set_space_before_token("/" === e.text[0], !0), this._is_wrap_attributes_force_expand_multiline && n.has_wrapped_attrs && t.print_newline(!1)), t.print_token(e)),
                        ...
                        (g.prototype._handle_inside_tag = function (t, e, n, i) {
                            ...
                            else if ("{" === n.tag_start_char && e.type === u.TEXT) t.print_preserved_newlines(e) ? ((e.newlines = 0), t.add_raw_token(e)) : t.print_token(e);
                            else {
                                if ((e.type === u.ATTRIBUTE ? (t.set_space_before_token(!0), (n.attr_count += 1)) : (e.type === u.EQUALS || (e.type === u.VALUE && e.previous.type === u.EQUALS)) && t.set_space_before_token(!1), e.type === u.ATTRIBUTE && "<" === n.tag_start_char && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (t.traverse_whitespace(e), (_ = _ || 0 !== e.newlines)), this._is_wrap_attributes_force))) {
                                ...
                                (s =
                                    ...
                                    (_
                                        ? (((p = function () {
                                          ...
                                          _(r + s, new p()))
                                        : r + (s = (p = e.whitespace_before) ? s.replace(new RegExp("\n(" + p + ")?", "g"), "\n") : s).replace(/\n/g, "\n" + r))),
                                    a && (s = s ? a + s + "\n" + o : a + o),
                                    t.print_newline(!1),
                        ...
                        (g.prototype._handle_tag_open = function (t, e, n, i) {
                            ...
                            return (
                                (!n.is_unformatted && !n.is_content_unformatted) || n.is_empty_element || e.type !== u.TAG_OPEN || 0 !== e.text.indexOf("</") ? (t.traverse_whitespace(e), this._set_tag_position(t, e, _, n, i), _.is_inline_element || t.set_wrap_point(), t.print_token(e)) : (t.add_raw_token(e), (_.start_tag_token = this._tag_stack.try_pop(_.tag_name))),
                        ...
                        (this.parent = t || null),
                            ...
                            e
                                ? ((this.tag_start_char = e.text[0]),
                                  (this.text = e.text),
                                  "<" === this.tag_start_char ? ((n = e.text.match(/^<([^\s>]*)/)), (this.tag_check = n ? n[1] : "")) : ((n = e.text.match(/^{{(?:[\^]|#\*?)?([^\s}]+)/)), (this.tag_check = n ? n[1] : ""), "{{#>" === e.text && ">" === this.tag_check && null !== e.next && (this.tag_check = e.next.text)),
                    ...
                    (g.prototype._get_tag_open_token = function (t) {
                        ...
                        return (
                            ...
                            (t.is_inline_element = r(t.tag_name, this._options.inline) || "{" === t.tag_start_char),
                            t
                        );
                    }),
                        (g.prototype._set_tag_position = function (t, e, n, i, _) {
                            n.is_empty_element || (n.is_end_tag ? (n.start_tag_token = this._tag_stack.try_pop(n.tag_name)) : (this._do_optional_end_element(n) && (n.is_inline_element || t.print_newline(!1)), this._tag_stack.record_tag(n), ("script" !== n.tag_name && "style" !== n.tag_name) || n.is_unformatted || n.is_content_unformatted || (n.custom_beautifier_name = s(n.tag_check, e)))),
                                r(n.tag_check, this._options.extra_liners) && (t.print_newline(!1), t._output.just_added_blankline() || t.print_newline(!0)),
                                n.is_empty_element
                                    ? ("{" === n.tag_start_char && "else" === n.tag_check && (this._tag_stack.indent_to_tag(["if", "unless", "each"]), (n.indent_content = !0), t.current_line_has_match(/{{#if/) || t.print_newline(!1)), ("!--" === n.tag_name && _.type === u.TAG_CLOSE && i.is_end_tag && -1 === n.text.indexOf("\n")) || (n.is_inline_element || n.is_unformatted || t.print_newline(!1), this._calcluate_parent_multiline(t, n)))
                                    : n.is_end_tag
                                    ? ((e = !1), (e = (e = n.start_tag_token && n.start_tag_token.multiline_content) || (!n.is_inline_element && !(i.is_inline_element || i.is_unformatted) && !(_.type === u.TAG_CLOSE && n.start_tag_token === i) && "TK_CONTENT" !== _.type)), (e = n.is_content_unformatted || n.is_unformatted ? !1 : e) && t.print_newline(!1))
                    ...
                    var o = ["address", "article", "aside", "blockquote", "details", "div", "dl", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hr", "main", "nav", "ol", "p", "pre", "section", "table", "ul"],
                        ...
                        if (!t.is_empty_element && t.is_start_tag && t.parent)
                            return (
                                "body" === t.tag_name
                                    ...
                                    ? (n = (n = (n = (n = n || this._tag_stack.try_pop("caption", ["table"])) || this._tag_stack.try_pop("colgroup", ["table"])) || this._tag_stack.try_pop("thead", ["table"])) || this._tag_stack.try_pop("tbody", ["table"]))
                                    : "tr" === t.tag_name
                                    ...
                                    : ("th" !== t.tag_name && "td" !== t.tag_name) || (n = (n = n || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"])) || this._tag_stack.try_pop("th", ["table", "thead", "tbody", "tfoot", "tr"])),
                ...
                function (t, e, n) {
                    var i = n(9).Tokenizer,
                        ...
                        a = n(12).Pattern,
                        o = { TAG_OPEN: "TK_TAG_OPEN", TAG_CLOSE: "TK_TAG_CLOSE", ATTRIBUTE: "TK_ATTRIBUTE", EQUALS: "TK_EQUALS", VALUE: "TK_VALUE", COMMENT: "TK_COMMENT", TEXT: "TK_TEXT", UNKNOWN: "TK_UNKNOWN", START: _.START, RAW: _.RAW, EOF: _.EOF },
                        p = new s(/<\!--/, /-->/),
                        s = function (t, e) {
                            i.call(this, t, e), (this._current_tag_name = "");
                            (t = new r(this._input).read_options(this._options)), (e = new a(this._input));
                            (this.__patterns = {
                                word: t.until(/[\n\r\t <]/),
                    ...
                    ((s.prototype = new i())._is_comment = function (t) {
                        ...
                        (s.prototype._get_next_token = function (t, e) {
                            ...
                            return null === n ? this._create_token(o.EOF, "") : this._read_open_handlebars(n, e) || this._read_attribute(n, t, e) || this._read_close(n, e) || this._read_raw_content(n, t, e) || this._read_content_word(n) || this._read_comment_or_cdata(n) || this._read_processing(n) || this._read_open(n, e) || this._create_token(o.UNKNOWN, this._input.next());
                        }),
                        (s.prototype._read_comment_or_cdata = function (t) {
                            var e = null,
                                n = null,
                                i = null;
                            return "<" === t && ("!" === this._input.peek(1) && ((n = this.__patterns.comment.read()) ? (i = p.get_directives(n)) && "start" === i.ignore && (n += p.readIgnored(this._input)) : (n = this.__patterns.cdata.read())), n && ((e = this._create_token(o.COMMENT, n)).directives = i)), e;
                        }),
                        (s.prototype._read_processing = function (t) {
                            var e = null,
                                n = null;
                            return "<" !== t || ((n = "!" === (t = this._input.peek(1)) || "?" === t ? (n = this.__patterns.conditional_comment.read()) || this.__patterns.processing.read() : n) && ((e = this._create_token(o.COMMENT, n)).directives = null)), e;
                        }),
                        (s.prototype._read_open = function (t, e) {
                            var n = null,
                                i = null;
                            return e || ("<" === t && ((n = this._input.next()), "/" === this._input.peek() && (n += this._input.next()), (n += this.__patterns.element_name.read()), (i = this._create_token(o.TAG_OPEN, n)))), i;
                        }),
                        (s.prototype._read_open_handlebars = function (t, e) {
                            var n = null,
                                i = null;
                            return e || (this._options.indent_handlebars && "{" === t && "{" === this._input.peek(1) && (i = "!" === this._input.peek(2) ? ((n = (n = this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars.read()), this._create_token(o.COMMENT, n)) : ((n = this.__patterns.handlebars_open.read()), this._create_token(o.TAG_OPEN, n)))), i;
                        }),
                        (s.prototype._read_close = function (t, e) {
                            var n = null,
                                i = null;
                            return e && ("<" === e.text[0] && (">" === t || ("/" === t && ">" === this._input.peek(1))) ? ((n = this._input.next()), "/" === t && (n += this._input.next()), (i = this._create_token(o.TAG_CLOSE, n))) : "{" === e.text[0] && "}" === t && "}" === this._input.peek(1) && (this._input.next(), this._input.next(), (i = this._create_token(o.TAG_CLOSE, "}}")))), i;
                        }),
                        (s.prototype._read_attribute = function (t, e, n) {
                            var i,
                                _ = null;
                            return n && "<" === n.text[0] && ("=" === t ? (_ = this._create_token(o.EQUALS, this._input.next())) : '"' === t || "'" === t ? ((n = this._input.next()), (n += ('"' === t ? this.__patterns.double_quote : this.__patterns.single_quote).read()), (_ = this._create_token(o.VALUE, n))) : (i = this.__patterns.attribute.read()) && (_ = e.type === o.EQUALS ? this._create_token(o.VALUE, i) : this._create_token(o.ATTRIBUTE, i))), _;
                        }),
                        ...
                        (s.prototype._read_raw_content = function (t, e, n) {
                            ...
                            if (n && "{" === n.text[0]) i = this.__patterns.handlebars_raw_close.read();
                                ...
                                if ("script" === e || "style" === e) {
                                    ...
                                    i = this._input.readUntil(new RegExp("</" + e + "[\\n\\r\\t ]*?>", "ig"));
                                } else this._is_content_unformatted(e) && (i = this._input.readUntil(new RegExp("</" + e + "[\\n\\r\\t ]*?>", "ig")));
                            }
                            return i ? this._create_token(o.TEXT, i) : null;
                        }),
                        (s.prototype._read_content_word = function (t) {
                            var e = "";
                            if ((e = (e = this._options.unformatted_content_delimiter && t === this._options.unformatted_content_delimiter[0] ? this.__patterns.unformatted_content_delimiter.read() : e) || this.__patterns.word.read())) return this._create_token(o.TEXT, e);
                        }),
