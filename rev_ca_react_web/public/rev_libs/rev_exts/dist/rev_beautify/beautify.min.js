        ...
        var n = [
                ...
                function (t, e, u) {
                    ...
                    (T.prototype.create_flags = function (t, e) {
                        var u = 0;
                        return (
                            t && ((u = t.indentation_level), !this._output.just_added_newline() && t.line_indent_level > u && (u = t.line_indent_level)),
                            {
                                mode: e,
                                parent: t,
                        ...
                        (T.prototype._reset = function (t) {
                            var e = t.match(/^[\t ]*/)[0];
                            (this._last_last_text = ""), (this._output = new n(this._options, e)), (this._output.raw = this._options.test_output_raw), (this._flag_store = []), this.set_mode(g);
                        ...
                        (T.prototype.handle_whitespace_and_comments = function (t, e) {
                            ...
                            if (n) for (var _ = 0; _ < u; _ += 1) this.print_newline(0 < _, e);
                    ...
                    (T.prototype.allow_wrap_or_preserved_newline = function (t, e) {
                        ...
                        (T.prototype.print_newline = function (t, e) {
                            if (!e && ";" !== this._flags.last_token.text && "," !== this._flags.last_token.text && "=" !== this._flags.last_token.text && (this._flags.last_token.type !== p.OPERATOR || "--" === this._flags.last_token.text || "++" === this._flags.last_token.text)) for (var u = this._tokens.peek(); !(this._flags.mode !== m || (this._flags.if_block && a(u, "else")) || this._flags.do_block); ) this.restore_mode();
                        ...
                        (T.prototype.print_token = function (t) {
                            ...
                            this._output.raw
                                ...
                                : (this._options.comma_first &&
                                      ...
                                      ((e = this._output.previous_line.pop()), this._output.previous_line.is_empty() && (this._output.previous_line.push(e), this._output.trim(!0), this._output.current_line.pop(), this._output.trim()), this.print_token_line_indentation(t), this._output.add_token(","), (this._output.space_before_token = !0)),
                        ...
                        (T.prototype.restore_mode = function () {
                            0 < this._flag_store.length && ((this._previous_flags = this._flags), (this._flags = this._flag_store.pop()), this._previous_flags.mode === m && E(this._output, this._previous_flags), this._output.set_indent(this._flags.indentation_level, this._flags.alignment));
                        }),
                        ...
                        (T.prototype.start_of_statement = function (t) {
                            return (
                                !!(
                                    ...
                                    (!(this._flags.parent.mode === k && this._flags.mode === m) && f(this._flags.last_token, A) && !t.newlines) ||
                                    ...
                                    (this._flags.last_token.type === p.WORD && this._flags.mode === g && !this._flags.in_case && !("--" === t.text || "++" === t.text) && "function" !== this._last_last_text && t.type !== p.WORD && t.type !== p.RESERVED) ||
                                    (this._flags.mode === k && ((":" === this._flags.last_token.text && 0 === this._flags.ternary_depth) || f(this._flags.last_token, ["get", "set"])))
                                ) && (this.set_mode(m), this.indent(), this.handle_whitespace_and_comments(t, !0), this.start_of_object_property() || this.allow_wrap_or_preserved_newline(t, f(t, ["do", "for", "if", "while"])), !0)
                            );
                        }),
                        (T.prototype.handle_start_expr = function (t) {
                            ...
                            if ("[" === t.text) {
                                ...
                                this._flags.last_token.type === p.RESERVED
                                    ...
                                    ? ((this._output.space_before_token = !1), (e = this._tokens.peek(-3)), this._options.space_after_named_function && e && ((u = this._tokens.peek(-4)), f(e, ["async", "function"]) || ("*" === e.text && f(u, ["async", "function"])) ? (this._output.space_before_token = !0) : this._flags.mode === k && (("{" !== e.text && "," !== e.text && ("*" !== e.text || ("{" !== u.text && "," !== u.text))) || (this._output.space_before_token = !0))))
                        ...
                        (T.prototype.handle_end_expr = function (t) {
                            ...
                            this.handle_whitespace_and_comments(t),
                                ...
                                this._options.space_in_paren && (this._flags.last_token.type !== p.START_EXPR || this._options.space_in_empty_paren ? (this._output.space_before_token = !0) : (this._output.trim(), (this._output.space_before_token = !1))),
                                this.deindent(),
                                this.print_token(t),
                                this.restore_mode(),
                        ...
                        (T.prototype.handle_start_block = function (t) {
                            ...
                            "switch" === this._flags.last_word && this._flags.last_token.type === p.END_EXPR
                                ...
                                ? this.set_mode(g)
                                : u && ((l(u.text, [":", ","]) && l(e.type, [p.STRING, p.WORD, p.RESERVED])) || (l(e.text, ["get", "set", "..."]) && l(u.type, [p.WORD, p.RESERVED])))
                                ? l(this._last_last_text, ["class", "interface"])
                                    ? this.set_mode(g)
                                    : this.set_mode(k)
                                : (this._flags.last_token.type !== p.OPERATOR || "=>" !== this._flags.last_token.text) && (l(this._flags.last_token.type, [p.EQUALS, p.START_EXPR, p.COMMA, p.OPERATOR]) || f(this._flags.last_token, ["return", "throw", "import", "default"]))
                                ? this.set_mode(k)
                                : this.set_mode(g);
                            (u = !e.comments_before && "}" === e.text), (e = u && "function" === this._flags.last_word && this._flags.last_token.type === p.END_EXPR);
                        ...
                        (T.prototype.handle_word = function (t) {
                            if (
                                (t.type === p.RESERVED && ((l(t.text, ["set", "get"]) && this._flags.mode !== k) || ("import" === t.text && "(" === this._tokens.peek().text) || (l(t.text, ["as", "from"]) && !this._flags.import_block) || (this._flags.mode === k && ":" === this._tokens.peek().text)) && (t.type = p.WORD),
                                this.start_of_statement(t)
                                    ? f(this._flags.last_token, ["var", "let", "const"]) && t.type === p.WORD && (this._flags.declaration_statement = !0)
                                    : !t.newlines || O(this._flags.mode) || (this._flags.last_token.type === p.OPERATOR && "--" !== this._flags.last_token.text && "++" !== this._flags.last_token.text) || this._flags.last_token.type === p.EQUALS || (!this._options.preserve_newlines && f(this._flags.last_token, ["var", "let", "const", "set", "get"]))
                                    ? this.handle_whitespace_and_comments(t)
                            ...
                            if (this._flags.in_case_statement && f(t, ["case", "default"])) return this.print_newline(), this._flags.last_token.type !== p.END_BLOCK && (this._flags.case_body || this._options.jslint_happy) && this.deindent(), (this._flags.case_body = !1), this.print_token(t), void (this._flags.in_case = !0);
                            if (((this._flags.last_token.type !== p.COMMA && this._flags.last_token.type !== p.START_EXPR && this._flags.last_token.type !== p.EQUALS && this._flags.last_token.type !== p.OPERATOR) || this.start_of_object_property() || this.allow_wrap_or_preserved_newline(t), a(t, "function")))
                                return (
                                    (l(this._flags.last_token.text, ["}", ";"]) || (this._output.just_added_newline() && !l(this._flags.last_token.text, ["(", "[", "{", ":", "=", ","]) && this._flags.last_token.type !== p.OPERATOR)) && (this._output.just_added_blankline() || t.comments_before || (this.print_newline(), this.print_newline(!0))),
                                    this._flags.last_token.type === p.RESERVED || this._flags.last_token.type === p.WORD
                                        ? f(this._flags.last_token, ["get", "set", "new", "export"]) || f(this._flags.last_token, A) || (a(this._flags.last_token, "default") && "export" === this._last_last_text) || "declare" === this._flags.last_token.text
                                            ? (this._output.space_before_token = !0)
                                            : this.print_newline()
                            ...
                            this._flags.last_token.type === p.END_BLOCK
                                ...
                                ? (e = "NEWLINE")
                                : this._flags.last_token.type === p.RESERVED || this._flags.last_token.type === p.WORD || ("*" === this._flags.last_token.text && (l(this._last_last_text, ["function", "yield"]) || (this._flags.mode === k && l(this._last_last_text, ["{", ","]))))
                                ? (e = "SPACE")
                                ...
                                f(t, ["else", "catch", "finally"])
                                    ? (this._flags.last_token.type !== p.END_BLOCK || this._previous_flags.mode !== g || "expand" === this._options.brace_style || "end-expand" === this._options.brace_style || ("none" === this._options.brace_style && t.newlines)) && !this._flags.inline_frame
                                        ? this.print_newline()
                                    ...
                                    ? f(this._flags.last_token, c) || ("declare" === this._flags.last_token.text && f(t, ["var", "let", "const"]))
                                        ...
                                        ? (this._flags.last_token.type === p.START_EXPR && f(t, ["var", "let", "const"])) || ":" === this._flags.last_token.text || (a(t, "if") && a(t.previous, "else") ? (this._output.space_before_token = !0) : this.print_newline())
                        ...
                        (T.prototype.handle_semicolon = function (t) {
                            ...
                            for (var e = this._tokens.peek(); !(this._flags.mode !== m || (this._flags.if_block && a(e, "else")) || this._flags.do_block); ) this.restore_mode();
                        ...
                        (T.prototype.handle_comma = function (t) {
                            this.handle_whitespace_and_comments(t, !0),
                                ...
                                this._flags.declaration_statement
                                    ? (O(this._flags.parent.mode) && (this._flags.declaration_assignment = !1), this._flags.declaration_assignment ? ((this._flags.declaration_assignment = !1), this.print_newline(!1, !0)) : this._options.comma_first && this.allow_wrap_or_preserved_newline(t))
                        ...
                        (T.prototype.handle_operator = function (t) {
                            ...
                            if ((this.start_of_statement(t) || this.handle_whitespace_and_comments(t, !e), f(this._flags.last_token, c))) return (this._output.space_before_token = !0), void this.print_token(t);
                            if ("*" !== t.text || this._flags.last_token.type !== p.DOT)
                                if ("::" !== t.text) {
                                    if ((this._flags.last_token.type === p.OPERATOR && l(this._options.operator_position, b) && this.allow_wrap_or_preserved_newline(t), ":" === t.text && this._flags.in_case)) return this.print_token(t), (this._flags.in_case = !1), (this._flags.case_body = !0), void (this._tokens.peek().type !== p.START_BLOCK ? (this.indent(), this.print_newline()) : (this._output.space_before_token = !0));
                                    var n = !0,
                                        i = !0,
                                        _ = !1;
                                    if ((":" === t.text ? (0 === this._flags.ternary_depth ? (n = !1) : (--this._flags.ternary_depth, (_ = !0))) : "?" === t.text && (this._flags.ternary_depth += 1), !u && !e && this._options.preserve_newlines && l(t.text, h))) {
                                        var s = ":" === t.text,
                                            a = s && _,
                                            o = s && !_;
                                    ...
                                    e
                                        ? (this.allow_wrap_or_preserved_newline(t), (n = !1), (i = (e = this._tokens.peek()) && l(e.type, [p.WORD, p.RESERVED])))
                                        : "..." === t.text
                                        ? (this.allow_wrap_or_preserved_newline(t), (n = this._flags.last_token.type === p.START_BLOCK), (i = !1))
                                        : (l(t.text, ["--", "++", "!", "~"]) || u) &&
                                          ...
                                          this._flags.last_token.type === p.RESERVED ? (n = !0) : this._flags.last_token.type === p.END_EXPR ? (n = !("]" === this._flags.last_token.text && ("--" === t.text || "++" === t.text))) : this._flags.last_token.type === p.OPERATOR && ((n = l(t.text, ["--", "-", "++", "+"]) && l(this._flags.last_token.text, ["--", "-", "++", "+"])), l(t.text, ["+", "-"]) && l(this._flags.last_token.text, ["--", "++"]) && (i = !0)),
                            ...
                            if ((this.print_newline(!1, e), this.print_token_line_indentation(t), this._output.add_token(_[0]), this.print_newline(!1, e), 1 < _.length)) {
                                for (
                                    n = (function (t, e) {
                                        ...
                                        i = (function (t, e) {
                                            for (var u, n = 0, i = t.length; n < i; n++) if ((u = t[n]) && 0 !== u.indexOf(e)) return !1;
                                            return !0;
                                        })(_, s),
                                    ...
                                    n ? (this.print_token_line_indentation(t), this._output.add_token(_[u].replace(/^\s+/g, ""))) : i && _[u] ? (this.print_token_line_indentation(t), this._output.add_token(_[u].substring(a))) : (this._output.current_line.set_indent(-1), this._output.add_token(_[u])), this.print_newline(!1, e);
                        ...
                        (T.prototype.handle_dot = function (t) {
                            this.start_of_statement(t) || this.handle_whitespace_and_comments(t, !0), f(this._flags.last_token, c) ? (this._output.space_before_token = !1) : this.allow_wrap_or_preserved_newline(t, ")" === this._flags.last_token.text && this._options.break_chained_methods), this._options.unindent_chained_methods && this._output.just_added_newline() && this.deindent(), this.print_token(t);
                        }),
                ...
                function (t) {
                    ...
                    (i.prototype.clone_empty = function () {
                        ...
                        (u.prototype.get_indent_size = function (t, e) {
                            ...
                            return t < 0 && (u = 0), (u += t * this.__indent_size), (u += e = e || 0);
                        }),
                        ...
                        (u.prototype.__add_column = function () {
                            var t,
                                ...
                                u = "";
                            this.__indent_size && e >= this.__indent_size && ((e -= (t = Math.floor(e / this.__indent_size)) * this.__indent_size), (u = new Array(t + 1).join(this.__indent_string))), e && (u += new Array(e + 1).join(" ")), this.__cache.push(u);
                        }),
                ...
                function (t) {
                    t.exports.Token = function (t, e, u, n) {
                        (this.type = t), (this.text = e), (this.comments_before = null), (this.newlines = u || 0), (this.whitespace_before = n || ""), (this.parent = null), (this.next = null), (this.previous = null), (this.opened = null), (this.closed = null), (this.directives = null);
                    };
                },
                function (t, e) {
                ...
                function (t, e, u) {
                    ...
                    function _(t) {
                        ...
                        for (var u = 0; u < e.length; u++) "preserve-inline" === e[u] ? (this.brace_preserve_inline = !0) : (this.brace_style = e[u]);
                ...
                function (t) {
                    ...
                    (e.prototype._get_array = function (t, e) {
                        ...
                        (e.prototype._get_selection = function (t, e, u) {
                            ...
                            if (1 !== u.length) throw new Error("Invalid Option Value: The option '" + t + "' can only be one of the following values:\n" + e + "\nYou passed in: '" + this.raw_options[t] + "'");
                            return u[0];
                        }),
                        (e.prototype._get_selection_list = function (t, e, u) {
                            ...
                            if (!this._is_valid_selection(u, e)) throw new Error("Invalid Option Value: The option '" + t + "' can contain only the following values:\n" + e + "\nYou passed in: '" + this.raw_options[t] + "'");
                            return u;
                        }),
                ...
                function (t, e, u) {
                    ...
                    var b,
                        ...
                        i = s.concat(["do", "in", "of", "else", "get", "set", "new", "catch", "finally", "typeof", "yield", "async", "await", "from", "as"]),
                        m = new RegExp("^(?:" + i.join("|") + ")$"),
                        i = function (t, e) {
                            n.call(this, t, e), (this._patterns.whitespace = this._patterns.whitespace.matching(/\u00A0\u1680\u180e\u2000-\u200a\u202f\u205f\u3000\ufeff/.source, /\u2028\u2029/.source));
                            (t = new a(this._input)), (e = new o(this._input).read_options(this._options));
                            this.__patterns = {
                                template: e,
                    ...
                    ((i.prototype = new n())._is_comment = function (t) {
                        ...
                        (i.prototype._read_singles = function (t) {
                            var e = null;
                            return (
                                "(" === t || "[" === t ? (e = this._create_token(p.START_EXPR, t)) : ")" === t || "]" === t ? (e = this._create_token(p.END_EXPR, t)) : "{" === t ? (e = this._create_token(p.START_BLOCK, t)) : "}" === t ? (e = this._create_token(p.END_BLOCK, t)) : ";" === t ? (e = this._create_token(p.SEMICOLON, t)) : "." === t && d.test(this._input.peek(1)) ? (e = this._create_token(p.DOT, t)) : "," === t && (e = this._create_token(p.COMMA, t)),
                                e && this._input.next(),
                                e
                            );
                        }),
                        ...
                        (i.prototype._read_non_javascript = function (t) {
                            ...
                            if ("#" === t) {
                                ...
                                if (this._input.hasNext() && this._input.testChar(c)) {
                                    ...
                                    return "#" === t || ("[" === this._input.peek() && "]" === this._input.peek(1) ? ((u += "[]"), this._input.next(), this._input.next()) : "{" === this._input.peek() && "}" === this._input.peek(1) && ((u += "{}"), this._input.next(), this._input.next())), this._create_token(p.WORD, u);
                                }
                                this._input.back();
                        ...
                        (i.prototype._read_comment = function (t) {
                            var e,
                                u = null;
                            return "/" === t && ((e = ""), "*" === this._input.peek(1) ? ((e = this.__patterns.block_comment.read()), (t = l.get_directives(e)) && "start" === t.ignore && (e += l.readIgnored(this._input)), (e = e.replace(r.allLineBreaks, "\n")), ((u = this._create_token(p.BLOCK_COMMENT, e)).directives = t)) : "/" === this._input.peek(1) && ((e = this.__patterns.comment.read()), (u = this._create_token(p.COMMENT, e)))), u;
                        }),
                                ...
                                this.has_char_escapes &&
                                    ...
                                    (e = (function (t) {
                                        var e = "",
                                            ...
                                            i = null;
                                        for (; n.hasNext(); )
                                            if (((i = n.match(/([\s]|[^\\]|\\\\)+/g)) && (e += i[0]), "\\" === n.peek())) {
                                                if ((n.next(), "x" === n.peek())) i = n.match(/x([0-9A-Fa-f]{2})/g);
                                                else {
                                                    if ("u" !== n.peek()) {
                                                ...
                                                if (!i) return t;
                                                if (126 < (u = parseInt(i[1], 16)) && u <= 255 && 0 === i[0].indexOf("x")) return t;
                        ...
                        (i.prototype._read_regexp = function (t, e) {
                            if ("/" === t && this._allow_regexp_or_xml(e)) {
                                for (var u = this._input.next(), n = !1, i = !1; this._input.hasNext() && (n || i || this._input.peek() !== t) && !this._input.testChar(r.newline); ) (u += this._input.peek()), n ? (n = !1) : ((n = "\\" === this._input.peek()), "[" === this._input.peek() ? (i = !0) : "]" === this._input.peek() && (i = !1)), this._input.next();
                            ...
                            if (this._options.e4x && "<" === t && this._allow_regexp_or_xml(e)) {
                                ...
                                if (n) {
                                    for (var i = n[2].replace(/^{\s+/, "{").replace(/\s+}$/, "}"), _ = 0 === i.indexOf("{"), s = 0; n; ) {
                                        var a = !!n[1],
                                            o = n[2];
                                        if ((!(!!n[n.length - 1] || "![CDATA[" === o.slice(0, 8)) && (o === i || (_ && o.replace(/^{\s+/, "{").replace(/\s+}$/, "}"))) && (a ? --s : ++s), (u += n[0]), s <= 0)) break;
                                        n = this.__patterns.xml.read_match();
                                    }
                                    return n || (u += this._input.match(/[\s\S]*/g)[0]), (u = u.replace(r.allLineBreaks, "\n")), this._create_token(p.STRING, u);
                                }
                            }
                            return null;
                        }),
                        (i.prototype._read_string_recursive = function (t, e, u) {
                            ...
                            for (var _ = i.read(), s = ""; this._input.hasNext(); ) {
                                ...
                                "\\" === s && this._input.hasNext()
                                    ...
                                    : u && ("${" === u && "$" === s && "{" === this._input.peek() && (s += this._input.next()), u === s && ((s += "`" === t ? this._read_string_recursive("}", e, "`") : this._read_string_recursive("`", e, "${")), this._input.hasNext() && (s += this._input.next()))),
                                    (_ += s += i.read());
                            }
                            return _;
                        }),
                ...
                function (t) {
                    ...
                    (e.prototype.restart = function () {
                        ...
                        (e.prototype.read = function (t, e, u) {
                            var n,
                                i = "";
                            return t && (n = this.match(t)) && (i += n[0]), !e || (!n && t) || (i += this.readUntil(e, u)), i;
                        }),
                        (e.prototype.readUntil = function (t, e) {
                            ...
                            return t ? ((n = t.index), e && (n += t[0].length)) : (n = this.__input_length), (u = this.__input.substring(this.__position, n)), (this.__position = n), u;
                        }),
                        ...
                        (e.prototype.get_regexp = function (t, e) {
                            var u = null,
                                e = e && n ? "y" : "g";
                            return "string" == typeof t && "" !== t ? (u = new RegExp(t, e)) : t && (u = new RegExp(t.source, e)), u;
                        }),
                ...
                function (t, e, u) {
                    var n = u(8).InputScanner,
                        ...
                        u = function (t, e) {
                            (this._input = new n(t)), (this._options = e || {}), (this.__tokens = null), (this._patterns = {}), (this._patterns.whitespace = new i(this._input));
                        };
                    (u.prototype.tokenize = function () {
                        ...
                        for (var e = new _(a.START, ""), u = null, n = [], i = new s(); e.type !== a.EOF; ) {
                            for (t = this._get_next_token(e, u); this._is_comment(t); ) i.add(t), (t = this._get_next_token(e, u));
                            i.isEmpty() || ((t.comments_before = i), (i = new s())), (t.parent = u), this._is_opening(t) ? (n.push(u), (u = t)) : u && this._is_closing(t, u) && (((t.opened = u).closed = t), (u = n.pop()), (t.parent = u)), ((t.previous = e).next = t), this.__tokens.add(t), (e = t);
                        }
                ...
                function (t, e, u) {
                    ...
                    ((i.prototype = new n()).__set_whitespace_patterns = function (t, e) {
                        ...
                        (i.prototype.__split = function (t, e) {
                            for (var u = (t.lastIndex = 0), n = [], i = t.exec(e); i; ) n.push(e.substring(u, i.index)), (u = i.index + i[0].length), (i = t.exec(e));
                            return u < e.length ? n.push(e.substring(u, e.length)) : n.push(""), n;
                        }),
                ...
                function (t, e, u) {
                    ...
                    function _(t, e) {
                        n.call(this, t, e), (this.__template_pattern = null), (this._disabled = Object.assign({}, i)), (this._excluded = Object.assign({}, i)), e && ((this.__template_pattern = this._input.get_regexp(e.__template_pattern)), (this._excluded = Object.assign(this._excluded, e._excluded)), (this._disabled = Object.assign(this._disabled, e._disabled)));
                        t = new n(t);
                        this.__patterns = {
                    ...
                    ((_.prototype = new n())._create = function () {
                        ...
                        (_.prototype._read_template = function () {
                            ...
                            return (
                                "<" === u
                                    ? ((t = this._input.peek(1)), this._disabled.php || this._excluded.php || "?" !== t || (e = e || this.__patterns.php.read()), this._disabled.erb || this._excluded.erb || "%" !== t || (e = e || this.__patterns.erb.read()))
                                    : "{" === u &&
                                      (this._disabled.handlebars || this._excluded.handlebars || (e = (e = (e = e || this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars_unescaped.read()) || this.__patterns.handlebars.read()),
                                      this._disabled.django || (this._excluded.django || this._excluded.handlebars || (e = e || this.__patterns.django_value.read()), this._excluded.django || (e = (e = e || this.__patterns.django_comment.read()) || this.__patterns.django.read())),
