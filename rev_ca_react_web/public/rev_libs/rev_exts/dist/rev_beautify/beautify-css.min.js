                ...
                function (t) {
                    ...
                    (_.prototype.clone_empty = function () {
                        ...
                        (i.prototype.get_indent_size = function (t, e) {
                            ...
                            return t < 0 && (i = 0), (i += t * this.__indent_size), (i += e = e || 0);
                        }),
                ...
                function (t) {
                    ...
                    (e.prototype.restart = function () {
                        ...
                        (e.prototype.readUntil = function (t, e) {
                            ...
                            return t ? ((n = t.index), e && (n += t[0].length)) : (n = this.__input_length), (i = this.__input.substring(this.__position, n)), (this.__position = n), i;
                        }),
                ...
                function (t, e, i) {
                    ...
                    (_.prototype.eatString = function (t) {
                        ...
                        (_.prototype.eatWhitespace = function (t) {
                            for (var e = v.test(this._input.peek()), i = 0; v.test(this._input.peek()); ) (this._ch = this._input.next()), t && "\n" === this._ch && (0 === i || i < this._options.max_preserve_newlines) && (i++, this._output.add_new_line(!0));
                            return e;
                        }),
                        ...
                        (_.prototype.beautify = function () {
                            ...
                            var i = (t = t.replace(y, "\n")).match(/^[\t ]*/)[0];
                            (this._output = new d(this._options, i)), (this._input = new g(t)), (this._indentLevel = 0), (this._nestedLevel = 0), (this._ch = null);
                            for (var n, _, s, r, h = 0, o = !1, p = !1, a = !1, u = !1, c = !1, l = this._ch; (n = "" !== this._input.read(m)), (_ = l), (this._ch = this._input.next()), "\\" === this._ch && this._input.hasNext() && (this._ch += this._input.next()), (l = this._ch), this._ch; )
                                "/" === this._ch && "*" === this._input.peek()
                                    ? (this._output.add_new_line(), this._input.back(), (r = this._input.read(b)), (s = f.get_directives(r)) && "start" === s.ignore && (r += f.readIgnored(this._input)), this.print_string(r), this.eatWhitespace(!0), this._output.add_new_line())
                                    : "/" === this._ch && "/" === this._input.peek()
                                    ...
                                    ? (this.preserveSingleSpace(n),
                                      "{" === this._input.peek()
                                          ...
                                          : (this.print_string(this._ch),
                                            (r = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g)).match(/[ :]$/) && ((r = this.eatString(": ").replace(/\s$/, "")), this.print_string(r), (this._output.space_before_token = !0)),
                                            "extend" === (r = r.replace(/\s$/, "")) ? (u = !0) : "import" === r && (c = !0),
                                            r in this.NESTED_AT_RULE ? ((this._nestedLevel += 1), r in this.CONDITIONAL_GROUP_RULE && (a = !0)) : o || 0 !== h || -1 === r.indexOf(":") || ((p = !0), this.indent())))
                                    : "#" === this._ch && "{" === this._input.peek()
                                    ? (this.preserveSingleSpace(n), this.print_string(this._ch + this.eatString("}")))
                                    : "{" === this._ch
                                    ? (p && ((p = !1), this.outdent()),
                                      (o = a ? ((a = !1), this._indentLevel >= this._nestedLevel) : this._indentLevel >= this._nestedLevel - 1),
                                      this._options.newline_between_rules && o && this._output.previous_line && "{" !== this._output.previous_line.item(-1) && this._output.ensure_empty_line_above("/", ","),
                                    ...
                                    : "}" === this._ch
                                    ? (this.outdent(), this._output.add_new_line(), "{" === _ && this._output.trim(!0), (u = c = !1), p && (this.outdent(), (p = !1)), this.print_string(this._ch), (o = !1), this._nestedLevel && this._nestedLevel--, this.eatWhitespace(!0), this._output.add_new_line(), this._options.newline_between_rules && !this._output.just_added_blankline() && "}" !== this._input.peek() && this._output.add_new_line(!0))
                                    : ":" === this._ch
                                    ? (!o && !a) || this._input.lookBack("&") || this.foundNestedPseudoClass() || this._input.lookBack("(") || u || 0 !== h
                                        ...
                                        : (this.print_string(":"), p || ((this._output.space_before_token = p = !0), this.eatWhitespace(!0), this.indent()))
                                    : '"' === this._ch || "'" === this._ch
                                    ? (this.preserveSingleSpace(n), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0))
                                    : ";" === this._ch
                                    ? 0 === h
                                        ? (p && (this.outdent(), (p = !1)), (c = u = !1), this.print_string(this._ch), this.eatWhitespace(!0), "/" !== this._input.peek() && this._output.add_new_line())
                                    ...
                                    ? this._input.lookBack("url")
                                        ...
                                        : (this.preserveSingleSpace(n), this.print_string(this._ch), this.eatWhitespace(), h++, this.indent())
                                    : ")" === this._ch
                                    ? (h && (h--, this.outdent()), this.print_string(this._ch))
                                    : "," === this._ch
                                    ? (this.print_string(this._ch), this.eatWhitespace(!0), !this._options.selector_separator_newline || p || 0 !== h || c || u ? (this._output.space_before_token = !0) : this._output.add_new_line())
                                    : (">" !== this._ch && "+" !== this._ch && "~" !== this._ch) || p || 0 !== h
                                    ? "]" === this._ch
                                        ? this.print_string(this._ch)
                                        : "[" === this._ch
                                        ? (this.preserveSingleSpace(n), this.print_string(this._ch))
                                        : "=" === this._ch
                                        ? (this.eatWhitespace(), this.print_string("="), v.test(this._ch) && (this._ch = ""))
                                        : ("!" !== this._ch || this._input.lookBack("\\") ? this.preserveSingleSpace(n) : this.print_string(" "), this.print_string(this._ch))
                                    ...
                                    : (this.print_string(this._ch), this.eatWhitespace(), this._ch && v.test(this._ch) && (this._ch = ""));
