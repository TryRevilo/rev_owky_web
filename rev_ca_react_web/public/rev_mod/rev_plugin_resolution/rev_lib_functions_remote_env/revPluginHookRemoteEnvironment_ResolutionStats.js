var revHookRemoteHandlerCallback = async (revVarArgs) => {
    ...
    if (revVarArgs && revVarArgs.revQuestion && revVarArgs.revRemoteHookMethods) {
        ...
        let revEntityStatsAnswersCountWrapperDefVal = await revRemoteHookMethods.revCountRevEntities_By_ContainerGuid_SubType({ "revContainerGUID": revEntityGUID, "revEntitySubType": "rev_store_sale_resolution" });
