var revHookRemoteHandlerCallback = async (revVarArgs) => {
    if (revVarArgs && revVarArgs.revRemoteHookMethods) {
        ...
        let revEntityContainerGUID = revReqParams.rev_resolution_request_guid;
        ...
        let revPassVarArgs = {
            "revCollectionLimit": 10,
            "revEntityContainerGUID": revEntityContainerGUID,
            "revEntitySubtype": "rev_resolution_answer",
        ...
        if (revLoggedInEntityGUID >= 1) {
            ...
            return Object.assign(revVarArgs, { "revResolutionRequestAnswersArr": revEntitySubTypesArr, "revEntityPublishersArr": revEntityPublishersArr });
        }
    }
