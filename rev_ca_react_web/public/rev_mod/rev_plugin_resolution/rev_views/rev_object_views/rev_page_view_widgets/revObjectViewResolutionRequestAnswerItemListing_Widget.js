var revPageViewWidget = async (revVarArgs) => {
    ...
    let revGetAnswerViewContainer = async () => {
        ...
        <div class="revFlexContainer revObjectAnswerListingItemContainer">
            <div class="revFlexWrapper revAnswerInfoHeaderWrapper">
                <div class="revTabLink revFontSiteBlueTxtColor revFontSizeLarge revAcceptAnswerTab"><i class="fas fa-check"></i></div>
