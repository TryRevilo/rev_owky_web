const revMenuItemPageOwnerOptionsReloadTabWidget = require("./rev_menu_items_widgets/revMenuItemPageOwnerOptionsReloadTabWidget");

var revPluginMenuItem = () => {
    return {
        "rev_plugin_name": "rev_plugin_core",
        "revNameId": "revMenuItemPageOwnerOptionsReloadTab",
        "revOverrideView": revMenuItemPageOwnerOptionsReloadTabWidget.revMenuItemWidget.toString(),
