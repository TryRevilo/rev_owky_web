var revPageViewWidget = async (revVarArgs) => {
    let revKiwiForm = await window.revGetForm("rev_kiwi");

    return `
        <div class="revFlexContainer revPublisherContainer">
            <div class="revpageOwnerHeader">
                <div class="revPageOwnerNames">
                    <i class="fa fa-user revUserIcon"></i><i class="fas fa-long-arrow-alt-right revUserIconArrowRight"></i><span class="revPageOwnerNames"></span>
                </div>
