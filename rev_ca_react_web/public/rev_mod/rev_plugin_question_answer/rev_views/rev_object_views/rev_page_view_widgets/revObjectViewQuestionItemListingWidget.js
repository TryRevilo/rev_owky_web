var revPageViewWidget = async (revVarArgs) => {
    ...
    window.revSetInterval(revQuestionListingItem_Id, () => {
        document.getElementById(revQuestionListingItem_Id).addEventListener("click", async (event) => {
            let revObjectViewQuestion = await window.revGetLoadedPageView("revObjectViewQuestion", revVarArgs);
            window.revDrawMainContentArea({ "revData": revVarArgs, "revLoadedPageView": revObjectViewQuestion, "revFloatingOptionsMenuName": "123" });
        });
    });
    ...
    <div class="revFlexContainer revQuestionItemContainer">
        <div class="revFlexWrapper">
            <div class="revFontSiteGreyTxtColor revFontSizeLarge"><i class="fab fa-quora"></i></div>
